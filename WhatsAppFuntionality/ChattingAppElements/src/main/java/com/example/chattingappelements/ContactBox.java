...
public class ContactBox implements Comparator<ContactBox>,Comparable<ContactBox> {
...
//                MainWindow.client.sendMessage(contactNumber+":"+message);
                textInput.clear();
                MainWindow.contactsTilesSorter();
            }
        });
...
//        int status = 0;
//
//        ContactBox c1 = (ContactBox)o1;
//        ContactBox c2 = (ContactBox)o2;
//
//        if (c1.getChatHistory().getLast().getTimestamp().isBefore(c2.getChatHistory().getLast().getTimestamp()))
//        {
//            status = -1;
//            return status; // it states that if message is before
//        }
//
//        return status;
//    }
    ...
    @Override
    public int compare(ContactBox o1, ContactBox o2) {
        if (o1.getChatHistory().getLast().getTime().isBefore(o2.getChatHistory().getLast().getTime())){
            return -1;
        }
        return 0;
    }
    ...
    @Override
    public int compareTo(ContactBox o) {

        if (this.getChatHistory().getLast().getTime().isAfter(o.getChatHistory().getLast().getTime())){
            return -1;
        }
        return 0;
    }
