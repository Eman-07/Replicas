...
//        contacts.get(0).setContactImage(new Image("file:sami2.png"));
        ...
        contacts.get(0).addMessage(new Message("hahahaha","Eman"));
        ...
        contacts.get(1).addMessage(new Message("Hello ","You"));
        contacts.get(1).addMessage(new Message("Como estas","Qamar"));
...
//            contactsBox.getChildren().add(box.create(primaryStage));
    ...
    public static void contactsTilesSorter(){

        contactsBox.getChildren().clear();

        HBox aiAgain = ai.createClown(stage);
        contactsBox.getChildren().add(aiAgain);
        Collections.sort(boxes);


        for (ContactBox box : boxes){
            contactsBox.getChildren().add(box.create(stage));
        }
    }
